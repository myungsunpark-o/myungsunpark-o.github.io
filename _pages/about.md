...
<div style="display: flex; gap: 8px; width: 100%; justify-content: center; align-items: stretch; margin: 30px 0; flex-wrap: nowrap;">
  
  <div style="flex: 1; min-width: 0;">
    <video autoplay loop muted playsinline style="width: 100%; height: 150px; object-fit: cover; display: block;">
