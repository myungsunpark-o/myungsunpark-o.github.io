...
<div style="display: flex; gap: 10px; align-items: flex-start; margin-top: 15px; flex-wrap: nowrap;">
  <img src="/images/research/2_1_hapticteleop.png" style="height: 120px; width: auto; object-fit: contain; border-radius: 8px; border: 1px solid #eee;">
  <img src="/images/research/2_2_tactilebenchmark.png" style="height: 120px; width: auto; object-fit: contain; border-radius: 8px; border: 1px solid #eee;">
</div>
...
<div style="display: flex; gap: 10px; align-items: flex-start; margin-top: 15px; flex-wrap: nowrap;">
  ...
  <img src="/images/research/2_4_robotswimming" style="height: 120px; width: auto; object-fit: contain; border-radius: 8px; border: 1px solid #eee;">
  <img src="/images/research/2_5_robotestimation" style="height: 120px; width: auto; object-fit: contain; border-radius: 8px; border: 1px solid #eee;">
</div>
